...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/background.jpg');">
  ...
  <div id="pageintro" class="hoc clear">
    ...
    <article>
        ...
        <h1 style="font-size:300%;"> <?php echo $Dati_cliente['nome'] . " " . $Dati_cliente['cognome'];  ?></h1>



        <a href="prenotazioni.php?ID_cliente=<?php echo $ID_cliente;?>" style="font-size:150%;">Visualizza le prenotazioni</a> <br> <br>
        <a href="piazzola.php?ID_cliente=<?php echo $ID_cliente;?>" style="font-size:150%;">Dati sulle tue piazzole</a> <br> <br>
        <a href="anagrafica.php?ID_cliente=<?php echo $ID_cliente;?>" style="font-size:150%;">I tuoi dati anagrafici</a>
