...
$query2="SELECT * FROM anagrafica WHERE ID_cliente=$ID_cliente";
...
$query2="SELECT * FROM postoveicoli WHERE ID_posto=$n6";

$Result=mysqli_query($conn,$query2);
//$query2="SELECT ID_cliente FROM anagrafica WHERE codice_fiscale='$n3';";
$Dati_veicolo = mysqli_fetch_array($Result);



if ($n7=="tenda") {

  $query2="SELECT * FROM postotende WHERE ID_posto=$n5";

}

else {
  $query2="SELECT * FROM postocamper WHERE ID_posto=$n5";
}
...
$Result=mysqli_query($conn,$query2);
//$query2="SELECT ID_cliente FROM anagrafica WHERE codice_fiscale='$n3';";
$Dati_posto = mysqli_fetch_array($Result);
...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/background.jpg');">
  ...
  <div id="pageintro" class="hoc clear">
    ...
    <article>
              ...
              <form method="post" action="prenotazione4.php">
                  <h1><?php echo $n1; ?></h1>
                  <table>
                    <tr>
                      <td><label style="color:black;text-align:left;">Cliente</label></td>
                      <td><label style="color:black;text-align:left;"><?php echo $Dati_cliente['nome'] . " " . $Dati_cliente['cognome'];  ?></label></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><label style="color:black;text-align:left;"><?php echo $Dati_cliente['tipo_documento'] ;  ?></label></td>
                    </tr>
                    <tr>
                      <td><label style="color:black;text-align:left;">N. documento</label></td>
                      <td><label style="color:black;text-align:left;"><?php echo $Dati_cliente['numero_documento'] ;  ?></label></td>
                    </tr>
                    <tr>
                      <td><label style="color:black;text-align:left;">Data inizio/fine</label></td>
                      <td><label style="color:black;text-align:left;"><?php echo $n3 . " / " . $n4 ;  ?></label></td>
                   </tr>
                   <tr>
                     <td><label style="color:black;text-align:left;">Campeggio</label></td>
                     <td><label style="color:black;text-align:left;"><?php echo $n1;  ?></label></td>
                  </tr>
                  <tr>
                    <td><label style="color:black;text-align:left;">Posto</label></td>
                    <td><label style="color:black;text-align:left;"><?php echo $Dati_posto['descrizione'];  ?></label></td>
                 </tr>
                 <tr>
                   <td><label style="color:black;text-align:left;">Posto veicolo</label></td>
                   <td><label style="color:black;text-align:left;"><?php echo $Dati_veicolo['descrizione']." - ".$Dati_veicolo['tipo'];  ?></label></td>
                </tr>
                  ...
                  <input type="hidden" id="ID_posto" name="ID_posto" value="<?php echo $n5; ?>"></input>
                  <input type="hidden" id="posto_veicolo_id" name="posto_veicolo_id" value="<?php echo $n6; ?>"></input>
                    <input type="hidden" id="cliente" name="cliente" value="<?php echo $ID_cliente; ?>"></input>
