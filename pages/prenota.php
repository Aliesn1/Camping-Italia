...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/background.jpg');">
  ...
  <!-- ################################################################################################ -->
  <!-- ################################################################################################ -->
  <div id="pageintro" class="hoc clear" style="text-align:center;">
        <h3 class="heading">Seleziona il campeggio</h3>
    <!-- ################################################################################################ -->
      ...
      <section id="introblocks">
        <ul class="nospace group btmspace-80">
          <li class="one_third first">
            <figure><a class="imgover" href="prenotazione.php?id=1&nome=Campeggio%20azzurro&ID_cliente=<?php echo $n1 ?>"><img src="../images/demo/CampeggioAzzurro.jpg" style="width:500px;height:220px;" alt=""></a>
              <figcaption>
                <h6 class="heading">Campeggio azzurro</h6>
                  <p>Campeggio situato sul lungomare di Tortoreto, nella provincia di Teramo in Abruzzo.</p>
              </figcaption>
            </figure>
          </li>
          <li class="one_third">
            <figure><a class="imgover" href="prenotazione.php?id=2&nome=Baia%20verde&ID_cliente=<?php echo $n1 ?>"><img src="../images/demo/BaiaVerde.jpg" style="width:500px;height:220px;" alt=""></a>
              <figcaption>
                <h6 class="heading">Baia verde</h6>
                  <p>Un campeggio sulla costa del mar ionio, a Taranto in Puglia.</p>
              </figcaption>
            </figure>
          </li>
          <li class="one_third">
            <figure><a class="imgover" href="prenotazione.php?id=3&nome=Laguna%20blu&ID_cliente=<?php echo $n1 ?>"><img src="../images/demo/LagunaBlu.jpg" style="width:500px;height:220px;" alt=""></a>
              <figcaption>
                <h6 class="heading">Laguna blu</h6>
                  <p>Campeggio che si affaccia sulla costa Ligure a Bogliasco, nella città metropolitana di Genova</p>
              </figcaption>
            </figure>
          </li>
        </ul>
