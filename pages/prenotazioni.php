...
$query="SELECT data_inizio, data_fine, posti.descrizione AS postidescr, campeggi.descrizione AS campdescr FROM posticlienti, posti, campeggi
  ...
  <div id="pageintro" class="hoc clear">
    ...
    <article>
                  ...
                  <table>
                    ...
                    <tr>
                      <td><label style="color:black;text-align:left;">Data inizio</label></td>
                      <td><label style="color:black;text-align:left;">Data fine</label></td>
                      <td><label style="color:black;text-align:left;">Piazzola</label></td>
                    ...
                    foreach ($Dati as $Dato ) {
                      ...
                      ?>
                      <tr>
                        <td><label style="color:black;text-align:left;"><?php echo $Dato['data_inizio'] ;  ?></label></td>
                        <td><label style="color:black;text-align:left;"><?php echo $Dato['data_fine'] ;  ?></label></td>
                        <td><label style="color:black;text-align:left;"><?php echo $Dato['postidescr'];  ?></label></td>
                        <td><label style="color:black;text-align:left;"><?php echo $Dato['campdescr'];  ?></label></td>
                        <br>
                      </tr>
                      <?php
                  ...
                  <a  style="font-size:150%;">Password Wi-Fi clienti: Camping-clienti</a> <br> <br>
